...
build:: $(OPENAPI_FILE)
	$(GO) install $(BUILD_FLAGS) $(VERSION_FLAGS) $(PROJECT)/cmd/$(PROVIDER)
	$(GO) install $(BUILD_FLAGS) $(VERSION_FLAGS) $(PROJECT)/cmd/$(CODEGEN)
...
install::
	GOBIN=$(PULUMI_BIN) $(GO) install $(BUILD_FLAGS) $(VERSION_FLAGS) $(PROJECT)/cmd/$(PROVIDER)
